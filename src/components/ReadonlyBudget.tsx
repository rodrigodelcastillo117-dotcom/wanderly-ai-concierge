        ...
        return (
          <div className="mt-6 pt-5 border-t border-border/40">
            ...
            >
              ...
              <ChevronDown
                className={`w-4 h-4 text-muted-foreground transition-transform duration-300 ${flightsOpen ? "rotate-180" : ""}`}
              />
            </button>
            <div
              className={`grid transition-all duration-300 ease-out ${flightsOpen ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}
            >
              <div className="overflow-hidden">
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-muted-foreground/70 italic pt-1">
                    Mostramos la opción más económica por ruta. La suma de tramos ({fmtMXN(sumLegs)}) puede variar respecto al total de vuelos ({fmtMXN(vuelosTotal)}) según la combinación final que elijas.
                  </p>
                </div>
              </div>
            </div>
